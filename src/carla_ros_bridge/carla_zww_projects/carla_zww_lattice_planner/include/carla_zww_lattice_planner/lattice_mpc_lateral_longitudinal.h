...
#include "carla_zww_lattice_planner/mpc_controller.h"
#include "carla_zww_lattice_planner/pid_controller.h"

#include "carla_zww_lattice_planner/helpers.h"
#include "carla_zww_lattice_planner/spline.h"
#include "carla_zww_lattice_planner/coordinate_transform.h"
#include "carla_zww_lattice_planner/lattice_planner.h"
#include "carla_zww_lattice_planner/frenet_path.h"
...
class LatticePlannerNode : public rclcpp::Node {
   ...
   private:
    ...
    // std::unique_ptr<zww::control::MPCController> mpc_controller_lateral;
