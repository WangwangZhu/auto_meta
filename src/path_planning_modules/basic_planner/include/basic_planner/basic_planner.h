...
public:
    ...
    rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr basic_planner_path_cartesian_publisher; // 广播规划器求解结果
    rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr basic_planner_path_frenet_publisher; // 广播规划器求解结果
    ...
    visualization_msgs::msg::Marker basic_planner_path_cardesian;
    geometry_msgs::msg::Point basic_planner_path_cardesian_points;

    nav_msgs::msg::Path basic_planner_path_frenet;
