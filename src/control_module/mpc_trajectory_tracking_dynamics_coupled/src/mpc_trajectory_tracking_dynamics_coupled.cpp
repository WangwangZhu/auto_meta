...
MpcTrajectoryTrackingPublisher::MpcTrajectoryTrackingPublisher() : Node("mpc_trajectory_tracking_publisher") // 使用初始化列表来初始化字段
{
    ...
    eps_feedback_subscription = this->create_subscription<chassis_msg::msg::WVCUHorizontalStatus>("publisher_eps_feedback", qos_, std::bind(&MpcTrajectoryTrackingPublisher::eps_feedback_callback, this, _1));
